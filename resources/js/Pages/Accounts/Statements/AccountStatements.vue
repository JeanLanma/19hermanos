...
onMounted( () => {
    document.getElementById('uploadExcel').addEventListener('change', function(event) {
        ...
        reader.onload = function(e) {
            ...
            let sheet = utils.sheet_to_json(workbook.Sheets[sheetName], { header: ["Fecha Operación", "Concepto", "Referencia", "Referencia Ampliada", "Cargo", "Abono", "Saldo"] });
            ...
            console.log(ParseJsonSheetToBBVATable(sheet));
            // Renderizar la tabla
            //Adding headers once
            let tr = document.createElement("tr");
            for (let key in AccountStatements.value.XLS.BBVA.headers) {
                let th = document.createElement("th");
                th.textContent = AccountStatements.value.XLS.BBVA.headers[key];
                tr.appendChild(th);
            }
